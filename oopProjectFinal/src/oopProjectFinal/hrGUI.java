...
public class hrGUI extends javax.swing.JFrame {
    ...
    int count=0;
    hr e ;
    ArrayList<hr> aList = new ArrayList();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(delet, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
...
dispose();
  ...
  String search = JOptionPane.showInputDialog("please enter name you want search for");
    ...
    private void deletActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletActionPerformed
      if(firstnameTF.getText().equals("")||surnameTF.getText().equals("")||dobTF.getText().equals("")||idTF.getText().equals("")||ppsnumberTF.getText().equals("")||addressTF.getText().equals("")){
   JOptionPane.showMessageDialog(null,"Please Fill all text fields for Business");
   }
   ...
   JOptionPane.showMessageDialog(null,"Your array is empty");
       ...
       ppsnumber=ppsnumberTF.getText();
        ...
        if(aList.get(i).getFirstname().equals(firstname)&&aList.get(i).getSurname().equals(surname)&&aList.get(i).getDob().equals(dob)&&aList.get(i).getId().equals(id)&&aList.get(i).getAddress().equals(address)&&aList.get(i).getPpsnumber().equals(ppsnumber)){
           aList.remove(i);
            count=count-1;
...
public void writeToFile(){
        try{
            File f= new File("output.dat");//declare and create file object
